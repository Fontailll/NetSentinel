...
REPO="Fontailll/NetSentinel"
BIN="/usr/local/bin/netsentinel"
...
try_prebuilt() {
    ...
    local url="https://github.com/${REPO}/releases/latest/download/netsentinel-linux-x86_64"
...
build_from_source() {
    ...
    cd NetSentinel 2>/dev/null || cd NetSentinel-main 2>/dev/null || true
...
printf "${CYAN}  NetSentinel Installer${NC}\n\n"
...
printf "\n${CYAN}Usage:${NC}\n"
printf "  sudo netsentinel           # Scan connections\n"
printf "  sudo netsentinel --all     # Full scan\n"
printf "  sudo netsentinel --watch   # Real-time monitoring\n"
printf "  netsentinel --help         # Options\n\n"
